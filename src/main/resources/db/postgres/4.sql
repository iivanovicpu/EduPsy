CREATE TABLE IF NOT EXISTS SUBJECT_LEVELS (
  ...
  name TEXT NOT NULL CONSTRAINT SUBJECT_LEVELS_UQ UNIQUE
);

INSERT INTO SUBJECT_LEVELS (name) VALUES ('OSNOVNO');
INSERT INTO SUBJECT_LEVELS (name) VALUES ('NAPREDNO');
...
UPDATE subjects SET subject_level_id = (SELECT id FROM SUBJECT_LEVELS WHERE name = 'OSNOVNO');

ALTER TABLE subjects ADD CONSTRAINT SUBJECTS_SUBJECT_LEVELS_FK FOREIGN KEY (subject_level_id) REFERENCES SUBJECT_LEVELS ON DELETE RESTRICT;
