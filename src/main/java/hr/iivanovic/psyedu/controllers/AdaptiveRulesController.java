...
public class AdaptiveRulesController extends AbstractController {
    ...
    public static Route fetchAllRulesForAdmin = (Request request, Response response) -> {
        ...
        if(LoginController.isEditAllowed(request)){
            ...
            model.put("adaptiverules", createView(dbProvider.getAllAdaptiveRules()));
    ...
    private static List<AdaptiveRuleView> createView(List<AdaptiveRule> data){
    ...
    @Data
    private static class AdaptiveRuleView extends AdaptiveRule {
